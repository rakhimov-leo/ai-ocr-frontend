...
const translations = {
    ko: {
        ...
        chatSendBtn: '전송',
        chatBotPreparing: '채팅 기능 준비 중입니다. 곧 이용하실 수 있습니다.',
        chatBotWhatIsThis: '여기는 AI-OCR 서비스 상담창입니다. 문서, 연금, 지사찾기, 서식 등에 대해 질문하세요. "도움"이라고 입력하면 안내해 드립니다.',
        chatBotHint: '아래 단어 중 하나를 입력해 보세요: 도움, 문서, 연금, 지사, 서식',
        chatBotHelp: '문서 업로드, 연금 계산, 지사 찾기 등 서비스를 이용할 수 있습니다. 상단 메뉴를 참고하세요.',
        chatBotDocsHint: '문서 보기는 상단 "문서" 메뉴에서 이용하실 수 있습니다.',
        chatBotOverloaded: 'AI 모델이 일시적으로 사용 중입니다. 잠시 후 다시 시도해 주세요.',
        statsTitle: '문서 통계',
        statsTotalDocs: '전체 문서',
        statsCompleted: '처리 완료',
        statsProcessing: '처리 중',
        statsNoData: '데이터를 불러올 수 없습니다.',
        webfaxRefresh: '새로고침',
        // Common
        loading: '로딩 중...',
        error: '오류',
    ...
    en: {
        ...
        chatSendBtn: 'Send',
        chatBotPreparing: 'Chat is being prepared. Available soon.',
        chatBotWhatIsThis: 'This is the AI-OCR service chat. Ask about documents, pension, branches, forms, etc. Type "help" for a short guide.',
        chatBotHint: 'Try typing one of these: help, documents, pension, branch, form',
        chatBotHelp: 'You can use document upload, pension calculator, find branch and other services. See the top menu.',
        chatBotDocsHint: 'You can view documents from the "Documents" menu above.',
        chatBotOverloaded: 'AI model is temporarily busy. Please try again in a moment.',
        statsTitle: 'Document statistics',
        statsTotalDocs: 'Total documents',
        statsCompleted: 'Completed',
        statsProcessing: 'Processing',
        statsNoData: 'Unable to load data.',
        webfaxRefresh: 'Refresh',
        loading: 'Loading...',
        error: 'Error',
        success: 'Success',
        logout: 'Logout',
    ...
    uz: {
        ...
        chatBotPreparing: 'Chat tayyorlanmoqda. Tez orada ishlatishingiz mumkin.',
        chatBotWhatIsThis: 'Bu yerda AI-OCR xizmatlari bo‘yicha savol berishingiz mumkin: hujjatlar, pensiya, filial, shakllar va boshqalar. Qisqa yo‘riqnoma uchun "yordam" deb yozing.',
        chatBotHint: 'Quyidagi so‘zlardan birini yozing: yordam, hujjat, pensiya, filial, shakl — shu bo‘yicha qisqacha ma’lumot beraman.',
        chatBotHelp: 'Hujjat yuklash, pensiya kalkulyatori, filial topish va boshqa xizmatlardan foydalanishingiz mumkin. Yuqoridagi menyuga qarang.',
        chatBotDocsHint: 'Hujjatlar sahifasini yuqoridagi "Hujjatlar" menyusidan ochishingiz mumkin.',
        chatBotOverloaded: 'AI modeli hozir band. Bir ozdan keyin qayta urinib ko\'ring.',
        statsTitle: 'Hujjatlar statistikasi',
        statsTotalDocs: 'Jami hujjatlar',
        statsCompleted: 'Qayta ishlangan',
        statsProcessing: 'Qayta ishlanmoqda',
        statsNoData: 'Ma\'lumotlarni yuklab bo\'lmadi.',
        webfaxRefresh: 'Yangilash',
        loading: 'Yuklanmoqda...',
        error: 'Xato',
    ...
    ru: {
        ...
        chatBotPreparing: 'Чат готовится. Скоро будет доступен.',
        chatBotWhatIsThis: 'Здесь можно задать вопрос по сервису AI-OCR: документы, пенсия, филиалы, формы. Напишите «помощь» для краткой подсказки.',
        chatBotHint: 'Напишите одно из слов: помощь, документы, пенсия, филиал, форма',
        chatBotHelp: 'Доступны загрузка документов, калькулятор пенсии, поиск филиала. См. меню выше.',
        chatBotDocsHint: 'Документы откроются в меню «Документы» выше.',
        chatBotOverloaded: 'Модель AI временно перегружена. Попробуйте позже.',
        statsTitle: 'Статистика документов',
        statsTotalDocs: 'Всего документов',
        statsCompleted: 'Обработано',
        statsProcessing: 'В обработке',
        statsNoData: 'Не удалось загрузить данные.',
        webfaxRefresh: 'Обновить',
        loading: 'Загрузка...',
        error: 'Ошибка',
        success: 'Успешно',
        logout: 'Выход',
    ...
    mn: {
        ...
        chatSendBtn: 'Илгээх',
        chatBotPreparing: 'Чат бэлтгэгдэж байна.',
        chatBotWhatIsThis: 'Энд AI-OCR үйлчилгээний талаар асууж болно: баримт, пенси, салбар, маягт. "Тусламж" гэж бичнэ үү.',
        chatBotHint: 'Дараах үгсээс нэгийг бичнэ үү: тусламж, баримт, пенси, салбар, маягт',
        chatBotHelp: 'Баримт байршуулах, пенсийн тооцоолуур, салбар хайх зэрэг үйлчилгээнээс ашиглана.',
        chatBotDocsHint: 'Дээрх "Баримт бичиг" цэснээс харах боломжтой.',
        chatBotOverloaded: 'AI загвар одоогоор ачаалалтай байна. Дараа дахин оролдоно уу.',
        statsTitle: 'Баримтын статистик',
        statsTotalDocs: 'Нийт баримт',
        statsCompleted: 'Боловсруулсан',
        statsProcessing: 'Боловсруулж байна',
        statsNoData: 'Өгөгдөл ачааллаагүй.',
        webfaxRefresh: 'Шинэчлэх',
    ...
    zh: {
        ...
        chatSendBtn: '发送',
        chatBotPreparing: '聊天功能准备中。',
        chatBotWhatIsThis: '此处可咨询 AI-OCR 服务：文档、养老金、分支机构、表格等。输入「帮助」获取简短指引。',
        chatBotHint: '请尝试输入其一：帮助、文档、养老金、分支、表格',
        chatBotHelp: '您可使用文档上传、养老金计算、查找分支机构等服务。请查看顶部菜单。',
        chatBotDocsHint: '请从顶部「文档」菜单查看文档。',
        chatBotOverloaded: 'AI 模型暂时繁忙，请稍后再试。',
        statsTitle: '文档统计',
        statsTotalDocs: '全部文档',
        statsCompleted: '已完成',
        statsProcessing: '处理中',
    ...
    vi: {
        ...
        chatSendBtn: 'Gửi',
        chatBotPreparing: 'Tính năng chat đang được chuẩn bị.',
        chatBotWhatIsThis: 'Đây là kênh tư vấn dịch vụ AI-OCR: tài liệu, lương hưu, chi nhánh, biểu mẫu. Gõ "giúp" để xem hướng dẫn.',
        chatBotHint: 'Thử gõ một trong các từ: giúp, tài liệu, lương hưu, chi nhánh, biểu mẫu',
        chatBotHelp: 'Bạn có thể dùng tải tài liệu, máy tính lương hưu, tìm chi nhánh. Xem menu trên.',
        chatBotDocsHint: 'Xem tài liệu tại menu "Tài liệu" phía trên.',
        chatBotOverloaded: 'Mô hình AI đang bận. Vui lòng thử lại sau.',
        statsTitle: 'Thống kê tài liệu',
        statsTotalDocs: 'Tổng tài liệu',
        statsCompleted: 'Đã xử lý',
        statsProcessing: 'Đang xử lý',
        statsNoData: 'Không tải được dữ liệu.',
        webfaxRefresh: 'Làm mới',
        loading: 'Đang tải...',
        error: 'Lỗi',
        success: 'Thành công',
        logout: 'Đăng xuất',
    ...
    th: {
        ...
        chatSendBtn: 'ส่ง',
        chatBotPreparing: 'ฟีเจอร์แชทกำลังเตรียมความพร้อม',
        chatBotWhatIsThis: 'นี่คือแชทให้คำปรึกษาบริการ AI-OCR เรื่องเอกสาร บำนาญ สาขา แบบฟอร์ม พิมพ์ "ช่วย" เพื่อดูคำแนะนำสั้นๆ',
        chatBotHint: 'ลองพิมพ์หนึ่งในคำเหล่านี้: ช่วย เอกสาร บำนาญ สาขา แบบฟอร์ม',
        chatBotHelp: 'คุณสามารถใช้บริการอัปโหลดเอกสาร เครื่องคิดเลขบำนาญ ค้นหาสาขา ดูเมนูด้านบน',
        chatBotDocsHint: 'ดูเอกสารได้ที่เมนู "เอกสาร" ด้านบน',
        chatBotOverloaded: 'โมเดล AI กำลังใช้งานสูง กรุณาลองใหม่ในภายหลัง',
        statsTitle: 'สถิติเอกสาร',
        statsTotalDocs: 'เอกสารทั้งหมด',
        statsCompleted: 'ดำเนินการแล้ว',
        statsProcessing: 'กำลังดำเนินการ',
        statsNoData: 'โหลดข้อมูลไม่ได้',
        webfaxRefresh: 'รีเฟรช',
        loading: 'กำลังโหลด...',
        error: 'ข้อผิดพลาด',
        success: 'สำเร็จ',
        logout: 'ออกจากระบบ',
...
function applyTranslations(lang) {
    ...
    if (branchMap && !branchMap.classList.contains('map-initialized')) {
        branchMap.textContent = t.pageBranchMapPlaceholder;
    }
    ...
    var aiChatWelcome = document.getElementById('aiChatWelcome');
    if (aiChatWelcome) aiChatWelcome.textContent = t.chatBotWhatIsThis || t.chatWelcome || 'Welcome! Ask about documents, pension, branch, form.';
